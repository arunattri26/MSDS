...
## Bias
I wanted to do a gender and race based analysis as well but based on discussion and situation around race and pronouns in media I refrained from it. I had a doubt if the registered shootings data could have inherent bias for these factors.